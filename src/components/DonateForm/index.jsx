...
const DonateForm = () => {
  ...
  const handleSubmit = useCallback(
    async data => {
      try {
        const paymentResult = await FakeService.makeRequest(data);
  ...
  const transition = useTransition({isSubmittedSuccessfully, paymentId, errorReason}, {
    from: {
      y: '150%',
      opacity: 0.0
    },
    ...
    keys: item => item.isSubmittedSuccessfully
  });
  ...
  return (
    <div className={style.container}>
      {transition((springStyle, {isSubmittedSuccessfully, paymentId, errorReason}) => {
        if (isSubmittedSuccessfully === null) {
          return (
                  ...
                  return (
                    <Form className={style.form}>
                      ...
                      <div className={style.buttonWrapper}>
                        <Button type="submit" className={style.button} color="red" disabled={isSubmitting}>
          ...
          return (
            <animated.div style={springStyle} className={style.animatedContentWrapper}>
              <PaymentResultNotification paymentId={paymentId} onClickOk={handleBackButton}
          ...
          return (
            <animated.div style={springStyle} className={style.animatedContentWrapper}>
              <PaymentResultNotification paymentId={paymentId} secondaryInfo={errorReason} onClickOk={handleBackButton}
